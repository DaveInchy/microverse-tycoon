import THREE, { DoubleSide, Euler, Group, Matrix4, Mesh, Object3D, Quaternion, Texture, Vector3 } from "three";
import ambient from "mods@shaders/textures/earth_ambient.jpg";
import clouds from "mods@shaders/textures/earth_atmosphere_colormap.jpg";
import color from "mods@shaders/textures/earth_colormap.jpg";
import depth from "mods@shaders/textures/earth_displacement.jpg";
import normal from "mods@shaders/textures/earth_normal.jpg";
import rings from "mods@shaders/textures/ring_colormap.png";
import shaders from "mods@shaders";
import specular from "mods@shaders/textures/earth_specular.jpg";
