import ambient from "mods@shaders/textures/venus_ambient.jpg";
import clouds from "mods@shaders/textures/venus_atmosphere_colormap.jpg";
import color from "mods@shaders/textures/venus_colormap.jpg";
import depth from "mods@shaders/textures/venus_displacement.jpg";
import normal from "mods@shaders/textures/venus_normal.jpg";
import specular from "mods@shaders/textures/venus_specular.jpg";
    ...
    return (
        <group ref={planetRef}>
            ...
            <mesh position={location}>
                <sphereGeometry
                    args={[10.1, 32, 16, Math.PI * (0 - offSet * 1.5), Math.PI * 2, 0, Math.PI * 1]}/>
                <meshPhongMaterial
                    map={T_CLOUDS}
                    opacity={0.5}
                    transparent={true}
