import ambient from "mods@textures/earth_ambient.jpg";
import clouds from "mods@textures/clouds_atmosphere_colormap.jpg";
import color from "mods@textures/earth_colormap.jpg";
import depth from "mods@textures/earth_displacement.jpg";
import normal from "mods@textures/earth_normal.jpg";
import specular from "mods@textures/earth_specular.jpg";
import { wait } from "mods@utils/wait";
import { MutableRefObject, useEffect, useRef, useState } from "react";
import { DoubleSide, Texture, Vector3 } from "three";
import { useTextureMap } from "./systems/useTextureMap";
    ...
    return (
        <group ref={planetRef}>
            ...
            <mesh position={location}>
                <sphereGeometry
                    args={[10.1, 64, 32, Math.PI * (offSet * 1.5), Math.PI * 2, 0, Math.PI * 1]} />
                <meshPhongMaterial
                    map={T_CLOUDS}
                    opacity={0.2}
                    transparent={true}
            ...
            <mesh position={location}>
                <sphereGeometry
                    args={[10, 64, 32, Math.PI * offSet, Math.PI * 2, 0, Math.PI * 1]} />
                <meshPhongMaterial
